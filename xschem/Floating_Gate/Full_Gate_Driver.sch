...
C {devices/code_shown.sym} 70 80 0 0 {name=LIB1 only_toplevel=false value="
...
C {devices/lab_pin.sym} -340 330 0 1 {name=l2 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -60 -40 1 1 {name=l1 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 0 -190 3 1 {name=l11 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -800 240 0 1 {name=l16 sig_type=std_logic lab=IN
}
